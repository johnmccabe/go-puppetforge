...
func (a *UserOperationsApiService) GetUser(ctx _context.Context, userSlug string, localVarOptionals *GetUserOpts) (User, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"user_slug"+"}", _neturl.PathEscape(parameterToString(userSlug, "")) , -1)
